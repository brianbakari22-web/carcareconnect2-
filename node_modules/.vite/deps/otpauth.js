...
var sha224 = createHasher(() => new _SHA224(), oidNist(4));
var sha512 = createHasher(() => new _SHA512(), oidNist(3));
var sha384 = createHasher(() => new _SHA384(), oidNist(2));
var _0n = BigInt(0);
var _1n = BigInt(1);
var _2n = BigInt(2);
var _7n = BigInt(7);
...
var sha3_224 = genKeccak(6, 144, 28, oidNist(7));
var sha3_256 = genKeccak(6, 136, 32, oidNist(8));
var sha3_384 = genKeccak(6, 104, 48, oidNist(9));
var sha3_512 = genKeccak(6, 72, 64, oidNist(10));
var globalScope = (() => {
...
var HOTP = class _HOTP {
  ...
  */
  static generate({ secret, algorithm = _HOTP.defaults.algorithm, digits = _HOTP.defaults.digits, counter = _HOTP.defaults.counter, hmac: hmac2 = hmacDigest }) {
    ...
    if (!(digest == null ? void 0 : digest.byteLength) || digest.byteLength < 19) {
...
var ALGORITHM_CUSTOM_REGEX = /^[A-Z0-9]+(?:[_-][A-Z0-9]+)*$/i;
var INTEGER_REGEX = /^[+-]?\d+$/;
  ...
  */
  static parse(uri, { hmac: hmac2 } = {}) {
    ...
    if (typeof uriParams.algorithm !== "undefined") {
      if ((hmac2 ? ALGORITHM_CUSTOM_REGEX : ALGORITHM_REGEX).test(uriParams.algorithm)) {
