...
const ROLES = [
  ...
  { key:"provider", icon:"Fix", title:"Garages and Shops", tagline:"List. Earn. Grow.", desc:"Reach thousands of vehicle owners across Kenya. Manage bookings, dispatch mechanics and receive instant payments.", color:"#378add", bg:"#eff6ff", border:"#378add25", img:"https://images.unsplash.com/photo-1625047509248-ec889cbff17f?w=600&q=80", cta:"List your business", path:"/auth", perks:["Keep up to 95%","Free to register","Real-time bookings","Mechanic management"] },
  { key:"mechanic", icon:"Wrn", title:"Mechanics", tagline:"Get jobs. Get paid.", desc:"Receive job assignments from your garage, track your earnings, upload before and after photos and grow your reputation.", color:"#1d9e75", bg:"#f0fdf4", border:"#1d9e7525", img:"https://images.unsplash.com/photo-1580273916550-e323be2ae537?w=600&q=80", cta:"Join as mechanic", path:"/mechanic-login", perks:["Assigned jobs","Earnings dashboard","Photo documentation","Parts requests"] },
  ...
  return (
    <div style={{ fontFamily:"DM Sans,sans-serif", background:"#fff", color:"#0f172a", overflowX:"hidden" }}>
        ...
        <div style={{ maxWidth:1200,margin:"0 auto",padding:"4rem 2rem",width:"100%",display:"grid",gridTemplateColumns:"1fr 1fr",gap:"4rem",alignItems:"center" }}>
          ...
          <div style={{ display:"grid",gridTemplateColumns:"1fr 1fr",gridTemplateRows:"1fr 1fr",gap:12,height:480 }}>
            ...
            <div className="role-img-wrap" style={{ borderRadius:20,overflow:"hidden",position:"relative",boxShadow:"0 8px 24px rgba(0,0,0,0.08)" }}>
              <img className="role-img" src="https://images.unsplash.com/photo-1489824904134-891ab64532f1?w=400&q=80" alt="Vehicle owner"/>
            ...
            <div className="role-img-wrap" style={{ borderRadius:20,overflow:"hidden",position:"relative",boxShadow:"0 8px 24px rgba(0,0,0,0.08)" }}>
              <img className="role-img" src="https://images.unsplash.com/photo-1609587312208-cea54be969e7?w=400&q=80" alt="Driver"/>
      ...
      <section style={{ position:"relative",overflow:"hidden" }}>
        <img src="https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=1400&q=85" alt="GO Service" style={{ width:"100%",height:460,objectFit:"cover",objectPosition:"center 40%",display:"block" }}/>
