      ...
      <div style={sec("rgba(255,255,255,0.82)")}>
        ...
        <div style={{ maxWidth:800, margin:"0 auto", position:"relative", zIndex:2 }}>
          ...
          <div style={{ display:"flex", flexDirection:"column", gap:8, marginBottom:"1.5rem" }}>
            {[["partsDealer","Engine and mechanical parts"],["accessories","Car accessories"],["tyreShop","Tyres all brands"],["autoElectrician","Batteries and electrical"],["earnings","Engine oils and fluids"]].map(([icon,item])=>(
