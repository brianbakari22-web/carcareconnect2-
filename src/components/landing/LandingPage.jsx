...
export default function LandingPage() {
  ...
  return (
    <div style={{ minHeight:"100vh", background:"#ffffff", color:"#e8e4dc", fontFamily:"DM Sans,sans-serif", overflowX:"hidden", position:"relative" }}>
        ...
        <div style={{ display:"grid", gridTemplateColumns:"repeat(auto-fit,minmax(220px,1fr))", gap:16 }}>
          {[
            ...
            <div key={r.role} className="hcard" style={{ background:"#141414", border:"1px solid "+r.color+"30", borderRadius:16, padding:"1.75rem" }}>
              ...
              <div style={{ fontSize:12, color:"#999999", marginBottom:14, lineHeight:1.6 }}>{r.desc}</div>
              {r.features.map(f=>(
      ...
      <div style={{ position:"relative", zIndex:1, maxWidth:900, margin:"0 auto 5rem", padding:"0 1.5rem" }}>
        <div style={{ textAlign:"center", marginBottom:"3rem" }}>
          ...
          <p style={{ fontSize:14, color:"#999999", marginTop:8 }}>No monthly fees. No hidden charges. We only make money when you make money.</p>
        </div>
        <div style={{ display:"grid", gridTemplateColumns:"repeat(auto-fit,minmax(190px,1fr))", gap:16 }}>
          {[
            ...
            <div key={p.type} className="hcard" style={{ background:"#141414", border:"1px solid "+p.color+"30", borderRadius:14, padding:"1.5rem", textAlign:"center" }}>
              ...
              <div style={{ fontSize:11, color:"#999999", marginBottom:10 }}>Your earnings</div>
              <div style={{ fontSize:11, color:"#dddddd", marginBottom:6 }}>Platform: {p.platform}</div>
              <div style={{ fontSize:11, color:"#bbbbbb", lineHeight:1.5 }}>{p.desc}</div>
            </div>
          ))}
        </div>
      </div>
            ...
            <div style={{ display:"grid", gridTemplateColumns:"repeat(2,1fr)", gap:10 }}>
              {[
                ...
                <div key={f.title} style={{ background:"#f5f5f5", borderRadius:12, padding:"1rem", textAlign:"center" }}>
                  ...
                  <div style={{ fontSize:11, color:"#999999" }}>{f.desc}</div>
                </div>
              ))}
            </div>
          </div>
