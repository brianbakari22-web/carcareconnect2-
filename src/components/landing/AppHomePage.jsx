...
const ROLES = [
  ...
  { key:"provider", emoji:"wrench", label:"Garages", title:"Garages and Shops", tagline:"List. Earn. Grow.", desc:"Reach thousands of vehicle owners across Kenya. Manage bookings, dispatch mechanics and get paid instantly.", color:"#378add", bg:"#eff6ff", border:"#378add25", img:"https://images.unsplash.com/photo-1625047509248-ec889cbff17f?w=700&q=85", actions:["Manage bookings","View earnings","GO requests","Manage mechanics"], path:"/auth" },
