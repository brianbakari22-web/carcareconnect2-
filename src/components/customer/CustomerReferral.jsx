  ...
  return (
    <div>
      ...
      <div style={{ background:"linear-gradient(135deg, #1a1208 0%, #111 100%)", border:"1px solid #e6821e30", borderRadius:16, padding:"1.5rem", marginBottom:"1.5rem" }}>
        <div style={{ fontFamily:"Syne", fontSize:16, fontWeight:800, color:"#f0ede6", marginBottom:4 }}>Your referral code</div>
        ...
        <div style={{ background:"#0a0a0a", borderRadius:10, padding:"1rem", marginBottom:"1rem", display:"flex", alignItems:"center", justifyContent:"space-between", gap:10 }}>
          <div>
            <div style={{ fontSize:10, color:"#555", textTransform:"uppercase", marginBottom:4 }}>Your code</div>
        ...
        <div style={{ background:"#0a0a0a", borderRadius:10, padding:"0.9rem", marginBottom:"1rem" }}>
          <div style={{ fontSize:10, color:"#555", textTransform:"uppercase", marginBottom:4 }}>Referral link</div>
        ...
        <div style={{ display:"flex", gap:8 }}>
          ...
          <button onClick={copyLink}
            style={{ background:"#1a1a1a", border:"1px solid #333", borderRadius:9, color:"#888", fontSize:13, padding:"11px 16px", cursor:"pointer" }}>
            🔗
          </button>
        </div>
      </div>
      ...
      <div style={{ background:"#111", border:"1px solid #1e1e1e", borderRadius:12, padding:"1.25rem", marginBottom:"1.5rem" }}>
        <div style={{ fontFamily:"Syne", fontSize:14, fontWeight:700, marginBottom:"1rem", color:"#f0ede6" }}>How it works</div>
        {[
          ...
          <div key={s.step} style={{ display:"flex", gap:12, marginBottom:i<3?12:0 }}>
            ...
            <div style={{ flex:1 }}>
              <div style={{ fontSize:13, fontWeight:600, color:"#f0ede6", marginBottom:2 }}>{s.title}</div>
      ...
      {!loading&&referrals.length===0&&(
        <div style={{ color:"#444", fontSize:13, textAlign:"center", padding:"2rem", background:"#111", borderRadius:10, border:"1px solid #1e1e1e" }}>
          No referrals yet. Share your code to get started!
        </div>
      )}
      {referrals.map(r=>(
        <div key={r.id} style={{ background:"#111", border:"1px solid #1e1e1e", borderRadius:10, padding:"1rem", marginBottom:8, display:"flex", alignItems:"center", gap:12 }}>
