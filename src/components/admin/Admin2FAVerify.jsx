    ...
    <div style={{ minHeight:"100vh", background:"#ffffff", display:"flex", alignItems:"center", justifyContent:"center", fontFamily:"'DM Sans',sans-serif" }}>
      ...
      <div style={{ width:"100%", maxWidth:380, padding:"0 1rem" }}>
        <div style={{ textAlign:"center", marginBottom:"2rem" }}>
          <div style={{ width:60, height:60, background:"#e6821e"Bg, borderRadius:14, display:"flex", alignItems:"center", justifyContent:"center", fontSize:28, margin:"0 auto 1rem", border:`1px solid ${"#e6821e"Border}` }}>🔐</div>
          <div style={{ fontFamily:"Syne", fontSize:22, fontWeight:800, color:"#000000", marginBottom:4 }}>Two-Factor Auth</div>
          <div style={{ fontSize:13, color:"#000000"Faint }}>Enter the 6-digit code from your authenticator app</div>
        </div>
        ...
        <form onSubmit={verify}>
          <input
            ...
            autoFocus
            style={{ width:"100%", background:"#ffffff"Card, border:`1px solid ${"#eeeeee"Light}`, borderRadius:10, padding:"16px", color:"#000000", fontSize:24, outline:"none", fontFamily:"monospace", letterSpacing:8, textAlign:"center", marginBottom:12 }}
          />
        ...
        <div style={{ textAlign:"center", marginTop:"1.5rem", fontSize:12, color:"#000000"VeryFaint }}>
