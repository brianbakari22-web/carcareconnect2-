...
export default function AdminRefunds() {
  ...
  return (
    <div style={{ maxWidth:600, margin:"0 auto", textAlign:"center", padding:"3rem 1rem" }}>
      ...
      <div style={{ fontFamily:"Syne", fontSize:isMobile?18:22, fontWeight:800, color:"#f0ede6", marginBottom:8 }}>
        Refunds have moved
      </div>
      ...
      <div style={{ display:"grid", gridTemplateColumns:isMobile?"1fr":"1fr 1fr", gap:12, marginBottom:"2rem", textAlign:"left" }}>
        {[
          ...
          <div key={item.label} style={{ background:"#111", border:`1px solid ${item.color}30`, borderRadius:12, padding:"1rem" }}>
