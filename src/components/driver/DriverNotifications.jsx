...
export default function DriverNotifications() {
  ...
  return (
    <div>
      ...
      {!loading&&notifications.length===0&&<div style={{ color:"#444", fontSize:13, textAlign:"center", padding:"3rem" }}><div style={{ fontSize:32, marginBottom:10 }}>🔔</div>No notifications yet</div>}
      {notifications.map(n=>(
