...
export default function DriverEarnings() {
  ...
  return (
    <div>
      ...
      <div style={{ background:"#071a12", border:"1px solid #1d9e7540", borderRadius:12, padding:"1.25rem", marginBottom:"1.5rem" }}>
        ...
        <div style={{ display:"grid", gridTemplateColumns:isMobile?"1fr 1fr":"repeat(4,1fr)", gap:10, marginBottom:12 }}>
          {[
            ...
            <div key={s.label} style={{ background:"#0a0a0a", borderRadius:8, padding:"0.75rem", textAlign:"center" }}>
      ...
      {/* How earnings work */}
      <div style={{ background:"#111", border:"1px solid #1e1e1e", borderRadius:10, padding:"0.9rem", marginBottom:"1.5rem" }}>
        <div style={{ fontFamily:"Syne", fontSize:12, fontWeight:700, color:"#f0ede6", marginBottom:8 }}>How your earnings work</div>
        {[
            ...
            <div style={{ display:"flex", justifyContent:"space-between", alignItems:"flex-start" }}>
              ...
              <div style={{ textAlign:"right", flexShrink:0 }}>
                ...
                <button onClick={()=>setExpanded(expanded===b.id?null:b.id)}
                  style={{ background:"none", border:"none", color:"#555", fontSize:10, cursor:"pointer", marginTop:2, padding:0 }}>
              ...
              <div style={{ marginTop:10, paddingTop:10, borderTop:"1px solid #1e1e1e" }}>
                <div style={{ display:"grid", gridTemplateColumns:"1fr 1fr 1fr", gap:8 }}>
                  {[
                    ...
                    <div key={f.l} style={{ background:"#0f0f0f", borderRadius:7, padding:"0.6rem", textAlign:"center" }}>
                      <div style={{ fontSize:12, fontWeight:700, color:f.c||"#f0ede6" }}>{f.v}</div>
                      <div style={{ fontSize:9, color:"#444", marginTop:2 }}>{f.l}</div>
                    </div>
                  ))}
                </div>
                <div style={{ display:"flex", justifyContent:"space-between", fontSize:12, color:"#1d9e75", fontWeight:700, marginTop:8, paddingTop:8, borderTop:"1px solid #1e1e1e" }}>
